            ...
            <div className='d-flex flex-column justify-content-center align-items-center'>            
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div className='entry-Ctn'>     
                        <input className='usrEnt' value={fields.firstName} type="text" autoComplete='off' name="firstName" placeholder='Elon' id="firstName"/> 
                    ...
                    <div className='entry-Ctn'>   
                        <input className='usrEnt' value={fields.lastName} type="text" autoComplete='off' name="lastName" placeholder='Musk' id="lastName"/> 
                    ...
                    <div className='entry-Ctn'>   
                        <input className='usrEnt' value={fields.dob} type="date" autoComplete='off' name="dob" id="dob" /> 
                    ...
                    <div className='regBtn-ctn'>
                        <button type='submit' className='reg-btn' onClick={()=>{}}>Sign up</button>
